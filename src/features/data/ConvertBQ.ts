...
//
//   const pointBQ = Convert.toPointBQ(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface PointBQ {
...
export class ConvertBQ {
  public static toPointBQ(json: string): PointBQ[] {
    return cast(json, a(r("PointBQ")));
  }

  public static pointBQToJson(value: PointBQ[]): string {
    return JSON.stringify(uncast(value, a(r("PointBQ"))), null, 2);
  }
}
